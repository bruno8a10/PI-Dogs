         ...
         if(temperaments){
           try{
               for(let i=0; i< ApiDogName.length;i++){
                   if(ApiDogName[i].temperament === temperaments){
                    const dog = {
                        id: ApiDogName[i].id,
                      ...
                      responseTemperamento.push(dog); 
                   }
               }
               if(responseTemperamento.length > 0){
                return res.status(200).json(responseTemperamento)
               }
